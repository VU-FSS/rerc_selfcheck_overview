...
self_check_data %>%
   ...
   standard_kable(caption="Number of completed checks by staff and PhD candidates by acedamic year") %>%
...
self_check_data %>%
   ...
   add_footnote(
     label = "The total number of issues is greater than the number of self-checks requiring full review, because projects may have more than one issue",
     notation = "none")
