...
The data is downloaded from qualtrics by rerc_selfcheck_qualtricsdownload.R and processed by rerc_selfcheck_analysis.R
...
kable(staff_overview_lastmonths,
	booktabs = T, 
	longtable=F,
	caption=paste("Number of completed checks by staff and PhD candidates in the last",months,"months",sep=" ", collapse=NULL),
	position="h") %>%
	kable_styling(latex_options = "striped") %>%
...
kable(students_overview_lastmonths, 
	booktabs = T,
	longtable=F ,
	caption=paste("Number of completed checks by master students in the last",months,"months",sep=" ", collapse=NULL),
	position="h")%>%
	kable_styling(latex_options = "striped") %>%
	row_spec(months,hline_after=TRUE)
